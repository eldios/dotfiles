  ...
  programs.waybar = {
    ...
    style = ''
      ...
      * {
      ...
      /* window#waybar is intentionally NOT styled here: the theme owns the
         bar background (bubble themes want a transparent strip). */
    ...
    settings = {
      primary = {
        ...
        # override include below so they can be changed at runtime without a
        # rebuild (a waybar include cannot override keys set in the main file).
