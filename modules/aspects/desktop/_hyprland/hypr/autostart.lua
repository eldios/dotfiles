...
-- one chosen last and falls back to a working one if it cannot.
o.exec_on_start(bin .. "desktop-switch \"$(cat \"${XDG_STATE_HOME:-$HOME/.local/state}/desktop-stack\" 2>/dev/null || echo omarchy)\"")
