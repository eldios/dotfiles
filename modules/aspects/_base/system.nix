...
in {
  ...
  # nixpkgs is configured on the system side only: home-manager.useGlobalPkgs
  # makes Home Manager reuse this package set, overlays included.
  ...
  nix = {
    ...
    settings = {
      ...
      # substituters and trusted-public-keys live in the nix-cache aspect.
    };
  };
