...
o.exec_on_start(bin .. "desktop-switch \"$(cat \"${XDG_STATE_HOME:-$HOME/.local/state}/desktop-stack\" 2>/dev/null || echo waybar)\"")

o.exec_on_start("sleep 1 && " .. bin .. "omarchy-theme-bg-set \"${XDG_STATE_HOME:-$HOME/.local/state}/omarchy/current/background\"")
